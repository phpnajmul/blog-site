                            ...
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                <form action="{{ route('update.news',$editData->id) }}" method="post" enctype="multipart/form-data" class="max-w-sm mx-auto">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="h-auto max-w-14 rounded-sm me-2 mt-2"><img src="{{  (!empty($editData->image))? url('upload/news/'.$editData->image):url('upload/no_image.jpg') }}" alt="Image"></div>
